...
mod tests {
    ...
    fn test_transfer() {
        ...
        assert!(contract.mt_token_holders(token.token_id.clone()).contains(&accounts(0)));
        ...
        let holders = contract.mt_token_holders(token.token_id.clone());
        ...
        assert!(contract.mt_token_holders(token.token_id.clone()).contains(&accounts(0)));
        assert!(!contract.mt_token_holders(token.token_id.clone()).contains(&accounts(1)));
    }
